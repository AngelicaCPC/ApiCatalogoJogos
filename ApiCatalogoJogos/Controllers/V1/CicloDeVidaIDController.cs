...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        public CicloDeVidaIDController(IExemploSingleton exemploSingleton1,
                                      ...
                                      // IExemploTransient _exemploTransient1,
                                      // IExemploTransient _exemploTransient2)
        {
        ...
        public interface IExemploTranscient : IExemploGeral 
        { }

        public class ExemploCicloDeVida : IExemploSingleton, IExemploScoped, IExemploTranscient
        {
